namespace Classbook.App.Components.Common.ToastNotifications
{
    ...
    public partial class BlazoredToasts
    {
        ...
        private ToastSettings BuildToastSettings(ToastLevel level, string message, string heading)
        {
            ...
            {
                ToastLevel.Info => new ToastSettings(string.IsNullOrEmpty(heading) ? "Инфо" : heading, message, "blazored-toast-info", this.InfoClass, this.InfoIconClass),
                ToastLevel.Success => new ToastSettings(string.IsNullOrEmpty(heading) ? "Успех" : heading, message, "blazored-toast-success", this.SuccessClass, this.SuccessIconClass),
                ToastLevel.Warning => new ToastSettings(string.IsNullOrEmpty(heading) ? "Внимание" : heading, message, "blazored-toast-warning", this.WarningClass, this.WarningIconClass),
                ToastLevel.Error => new ToastSettings(string.IsNullOrEmpty(heading) ? "Грешка" : heading, message, "blazored-toast-error", this.ErrorClass, this.ErrorIconClass),
